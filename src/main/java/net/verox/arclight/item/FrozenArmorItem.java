...
public class FrozenArmorItem extends ArmorItem implements IAnimatable {

    private final AnimationFactory factory = new AnimationFactory(this);

    private static final Map<ArmorMaterial, StatusEffectInstance> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<ArmorMaterial, StatusEffectInstance>())
                    .put(ModArmorMaterials.FROZEN,
                            new StatusEffectInstance(StatusEffects.WATER_BREATHING, 20, 2,
                                    false, false)).build();
            ...
            (new ImmutableMap.Builder<ArmorMaterial, StatusEffectInstance>())
                    .put(ModArmorMaterials.FROZEN,
                            new StatusEffectInstance(StatusEffects.SPEED, 20, 0,
                                    false, false)).build();
    public FrozenArmorItem(ArmorMaterial material, EquipmentSlot slot, Settings settings) {
    ...
    private <P extends IAnimatable> PlayState predicate(AnimationEvent<P> event) {
        ...
        boolean isWearingAll = armorList.containsAll(Arrays.asList(ModItems.FROZEN_BOOTS,
                ModItems.FROZEN_LEGGINGS, ModItems.FROZEN_CHESTPLATE, ModItems.FROZEN_HELMET));
